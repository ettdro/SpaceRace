...
feature {NONE} -- Initialization
	...
	make (a_fenetre: FENETRE; a_musique: EFFET_SONORE; a_son_click: EFFET_SONORE)
		...
		do
			...
			create titre.creer_affichable (fenetre.fenetre.renderer, "./images/choisir_piste.png")
			create cadre.creer_affichable (fenetre.fenetre.renderer, "./images/bordure_pistes.png")
			create cadre_selectionne.creer_affichable (fenetre.fenetre.renderer, "./images/bordure_pistes_selectionne.png")
			create piste_verte.creer_affichable (a_fenetre.fenetre.renderer, "./images/piste_V_cadre.png")
			create piste_jaune.creer_affichable (a_fenetre.fenetre.renderer, "./images/piste_J_cadre.png")
			create piste_mauve.creer_affichable (a_fenetre.fenetre.renderer, "./images/piste_M_cadre.png")
			create piste_bleue.creer_affichable (a_fenetre.fenetre.renderer, "./images/piste_B_cadre.png")
...
feature {ANY} -- Access
	...
	valider_cadre_haut_gauche (a_x, a_y: INTEGER)
			...
			-- `Bouton_cadre_haut_gauche_coordonnees' et exécute l'action en conséquence.
		do
			if
	...
	valider_cadre_haut_droite (a_x, a_y: INTEGER)
			-- Méthode vérifiant si les coordonnées de la souris `a_x' et `a_y' sont égales aux coordonnées du bouton
			-- `Bouton_cadre_haut_droite_coordonnees' et exécute l'action en conséquence.
		do
			if
	...
	valider_cadre_bas_gauche (a_x, a_y: INTEGER)
			-- Méthode vérifiant si les coordonnées de la souris `a_x' et `a_y' sont égales aux coordonnées du bouton
			-- `Bouton_cadre_bas_gauche_coordonnees' et exécute l'action en conséquence.
		do
			if
	...
	valider_cadre_bas_droite (a_x, a_y: INTEGER)
			-- Méthode vérifiant si les coordonnées de la souris `a_x' et `a_y' sont égales aux coordonnées du bouton
			-- `Bouton_cadre_bas_droite_coordonnees' et exécute l'action en conséquence.
		do
			if

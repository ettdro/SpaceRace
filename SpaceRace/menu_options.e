...
feature {ANY} -- Access
	...
	valider_bouton_muet (a_x, a_y: INTEGER)
			-- Méthode vérifiant si les coordonnées de la souris `a_x' et `a_y' sont égales aux coordonnées de
			-- `Bouton_muet_coordonnees' et exécute l'action en conséquence.
		do
			if
	...
	valider_bouton_credits (a_x, a_y: INTEGER)
			...
			-- `Bouton_credit_coordonnees' et exécute l'action en conséquence.
		do
			if
	...
	valider_bouton_comment_jouer (a_x, a_y: INTEGER)
			-- Méthode vérifiant si les coordonnées de la souris `a_x' et `a_y' sont égales aux coordonnées du bouton
			-- `Bouton_comment_jouer_coordonnees' et exécute l'action en conséquence.
		do
			if

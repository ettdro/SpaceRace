...
feature {NONE} -- Initialization
	...
	make (a_fenetre: FENETRE; a_musique: EFFET_SONORE; a_son_click: EFFET_SONORE; a_piste_selectionne: PISTE; a_vaisseau_selectionne: VAISSEAU)
		...
		do
			...
			create bouton_muet.creer_affichable (fenetre.fenetre.renderer, "./images/bouton_muet_jeu.png")
			create bouton_non_muet.creer_affichable (fenetre.fenetre.renderer, "./images/bouton_non_muet_jeu.png")
			create titre_tours.creer_affichable (fenetre.fenetre.renderer, "./images/titre_tours.png")
			create titre_chrono.creer_affichable (fenetre.fenetre.renderer, "./images/titre_chrono.png")
			create bouton_retour.creer_affichable (fenetre.fenetre.renderer, "./images/bouton_retour.png")
			create bouton_pause.creer_affichable (fenetre.fenetre.renderer, "./images/bouton_pause.png")
			create bouton_jouer.creer_affichable (fenetre.fenetre.renderer, "./images/bouton_jouer2.png")
			create image_pause.creer_affichable (fenetre.fenetre.renderer, "./images/popup_pause.png")
			create image_cliquez_jouer.creer_affichable (fenetre.fenetre.renderer, "./images/cliquez_jouer.png")
			create son_vaisseau.creer_son ("./sons/Vaisseau.wav")
			create son_vaisseau_fin.creer_son ("./sons/Vaisseau_Fin.wav")
